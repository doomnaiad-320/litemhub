...
func SetAPIRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.AdminAuth)
	{
		...
		appUsersRoute := apiRouter.Group("/app_users")
		{
			...
			appUsersRoute.GET("/billing_settings", controller.GetAppBillingSettings)
			appUsersRoute.PUT("/billing_settings", controller.UpdateAppBillingSettings)
			appUsersRoute.POST("/", controller.CreateAppUser)
		...
		announcementsRoute := apiRouter.Group("/announcements")
		{
			...
			announcementsRoute.PUT("/:id", controller.UpdateAnnouncement)
			announcementsRoute.DELETE("/:id", controller.DeleteAnnouncement)
		...
		logsRoute := apiRouter.Group("/logs")
		{
			...
			logsRoute.GET("/stats", controller.GetLogStats)
		...
		logRoute := apiRouter.Group("/log")
		{
			...
			logRoute.GET("/:group/stats", controller.GetGroupLogStats)
