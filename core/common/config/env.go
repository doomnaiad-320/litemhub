...
func ReloadEnv() {
	...
	SetDuluPayRechargeDiscount(env.Float64("DULUPAY_RECHARGE_DISCOUNT", 1))
	SetDuluPayDiscountCodeDiscount(env.Float64("DULUPAY_DISCOUNT_CODE_DISCOUNT", 0))
	SetDuluPayRechargeRebateRatio(env.Float64("DULUPAY_RECHARGE_REBATE_RATIO", 0))
