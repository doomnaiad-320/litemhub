...
export default function PublicAgreementPage() {
    ...
    return (
        <div className="min-h-screen overflow-x-hidden bg-white font-['DM_Sans',_'Helvetica_Neue',_Arial,_sans-serif] text-[#222222] transition-colors duration-200 dark:bg-[#080b12] dark:text-white">
            ...
            <main className="relative overflow-hidden border-b border-[#f2f3f5] bg-white dark:border-white/10 dark:bg-[#080b12]">
                ...
                <div className="relative mx-auto max-w-3xl px-4 py-10 sm:px-6 lg:py-14">
                    <Button
                        asChild
                        variant="outline"
                        className="mb-6 h-10 rounded-[8px] border-[#e5e7eb] bg-white px-4 text-sm font-medium text-[#333333] shadow-[rgba(36,36,36,0.04)_0px_8px_18px] hover:bg-[#f5f7fb] dark:border-white/10 dark:bg-white/5 dark:text-white dark:shadow-none dark:hover:bg-white/10"
                    >
                    ...
                    <article className="rounded-[13px] border border-[#f2f3f5] bg-white px-5 py-6 shadow-[rgba(36,36,36,0.04)_0px_12px_24px] dark:border-white/10 dark:bg-[#0b0f18] dark:shadow-none sm:px-8 sm:py-8">
