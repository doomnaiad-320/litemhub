                    ...
                    <div className="flex flex-col gap-5 border-b border-border/60 px-6 py-6">
                        <div className="flex flex-wrap items-start justify-between gap-4">
                            ...
                            <div className="flex flex-wrap items-center gap-2">
                                ...
                                >
                                    <SelectTrigger className="h-10 w-[140px] rounded-md border-border bg-background shadow-none">
                                        <SelectValue />
                                    </SelectTrigger>
                                    <SelectContent>
                                ...
                                >
                                    <SelectTrigger className="h-10 w-[150px] rounded-md border-border bg-background shadow-none">
                                        <SelectValue />
                                    </SelectTrigger>
                                    <SelectContent>
