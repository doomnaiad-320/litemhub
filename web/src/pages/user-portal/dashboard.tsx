            ...
            <div className="grid gap-6 xl:grid-cols-[minmax(0,1fr)_292px]">
                ...
                <aside className="space-y-5">
                    <section className="rounded-lg border border-[#e5e7eb] bg-background p-5 shadow-none dark:border-white/10">
                        ...
                        <div className="mt-4 border-t border-[#f2f3f5] pt-4 dark:border-white/10">
                            {isDiscountCodeLoading ? (
                                <Skeleton className="h-10 w-full rounded-md" />
                            ) : myDiscountCode ? (
                                <div className="flex items-center gap-2">
                                    <div className="min-w-0 flex-1 rounded-md border border-[#e5e7eb] bg-[#fafafa] px-3 py-2 font-mono text-sm font-semibold tracking-[0.08em] text-[#18181b] dark:border-white/10 dark:bg-white/[0.03] dark:text-white">
                                        {myDiscountCode}
                                    </div>
                                    <Button
                                        type="button"
                                        ...
                                        className="h-10 rounded-md border-[#e5e7eb] bg-background px-3 shadow-none hover:border-[#18181b] hover:bg-background dark:border-white/10"
                                    >
                                ...
                                <Button
                                    ...
                                    className="h-10 w-full rounded-md bg-[#181e25] text-white shadow-none hover:bg-[#111827] dark:bg-white dark:text-[#181e25]"
                                >
