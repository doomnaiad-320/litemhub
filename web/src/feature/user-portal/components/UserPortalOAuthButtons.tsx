...
export function UserPortalOAuthButtons({
    ...
    const divider = (
        <div className="flex items-center gap-3">
            <div className="h-px flex-1 bg-[#e5e7eb] dark:bg-border" />
            <span className="text-[11px] font-medium uppercase tracking-[0.24em] text-[#8e8e93] dark:text-muted-foreground">
                ...
                {userPortalOAuthProviders.map((provider) => {
                    ...
                    return (
                        <Button
                            ...
                            variant="outline"
                            className={cn(
                                'h-10 w-full rounded-[8px] border-[#d9d9d9] bg-white px-4 text-sm font-medium text-[#151515] shadow-none transition hover:bg-[#f7f7f7] active:translate-y-px dark:border-border dark:bg-muted dark:text-foreground dark:hover:bg-accent',
                            )}
                        >
                            <a
                                href={provider.href}
...
function GitHubIcon() {
    return (
        <span className="flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-black/[0.05] text-[#151515] dark:bg-accent dark:text-foreground">
...
function GoogleOAuthIcon() {
    return (
        <span className="relative flex h-5 w-5 shrink-0 items-center justify-center overflow-hidden rounded-full">
            ...
            <span className="absolute inset-[2px] rounded-full bg-white dark:bg-muted" />
