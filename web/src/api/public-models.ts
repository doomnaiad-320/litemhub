...
import type { PublicModel, PublicModelsResponse } from "@/types/public-model";
...
export const publicModelsApi = {
  getModels: async () => get<PublicModelsResponse>("models"),
  getModel: async (model: string) =>
    get<PublicModel>(`models/${encodeURIComponent(model)}`),
};
